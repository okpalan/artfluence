...
3. **Step 2: Create Vector Motifs:**
   - Use the pen tool to outline the lion and tiger head motifs.
   - Show techniques for achieving clean lines and shapes.

4. **Step 3: Choose Colors:**
   - Select a vibrant color palette reflecting Igbo culture.
...
2. **Step 1: Character Sketching:**
   - Create a rough sketch of Uche Nnamdi, focusing on simplified features and key elements of Igbo attire, including the Igbo hat with eagle feathers and an Igbo necklace.
...
5. **Step 4: Finalize the Character Design:**
   - Discuss details like facial expressions, accessories (hat, necklace, watch), and cultural elements.
